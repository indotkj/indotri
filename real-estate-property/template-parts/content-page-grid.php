...
<article id="post-<?php the_ID(); ?>" <?php post_class('blog-post'); ?>>
	<?php if ( 
	    true == get_theme_mod( 'real_estate_property_post_heading_on_off', 'on' ) || 
	    true == get_theme_mod( 'real_estate_property_post_content_on_off', 'on' ) || 
	    true == get_theme_mod( 'real_estate_property_post_image_on_off', 'on' )) : ?>
	<?php if ( has_post_thumbnail() ) { ?> 
    <div class="post-thumb">
        <?php if ( true == get_theme_mod( 'real_estate_property_post_image_on_off', 'on' ) ) : ?>
	...
	<div class="post-content">
		...
		<?php if ( true == get_theme_mod( 'real_estate_property_post_content_on_off', 'on' ) ) : ?>
			<p><?php echo wp_trim_words( get_the_content(), get_theme_mod('real_estate_property_post_content_limit',15) );?></p>
		<?php endif; ?>
	</div>
	<?php endif; ?>
		<?php if ( 
		    true == get_theme_mod( 'real_estate_property_post_date_on_off', 'on' ) || 
		    true == get_theme_mod( 'real_estate_property_post_comment_on_off', 'on' ) || 
		    true == get_theme_mod( 'real_estate_property_post_author_on_off', 'on' ) || 
		    true == get_theme_mod( 'real_estate_property_post_categories_on_off', 'on' )) : ?>
		    <ul class="meta-info">
