		...
		<div id="lefty">
			<div id="description">
				...
				<div class="demo-import-box">
					...
					<p><?php echo esc_html('If the Kirki Customizer plugin is not installed or activated, please install or activate it first. Then proceed with the demo content import.','real-estate-property'); ?></p>
