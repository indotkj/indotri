...
<?php if ( is_active_sidebar( 'footer-widget-area' ) ) { ?>
    <?php if ( true == get_theme_mod( 'real_estate_property_footer_widgets_on_off', 'off' ) ) : ?>
...
<?php
	...
	$real_estate_property_copyright_content_text   = get_theme_mod('real_estate_property_copyright_content_text','Property WordPress Theme');
?>
...
<?php endif; ?>
<?php if( get_theme_mod( 'real_estate_property_scroll_to_top_setting',true) == 1 || get_theme_mod( 'real_estate_property_responsive_scroll_to_top_setting',true) == 1) { ?>
    <?php if ( get_theme_mod( 'real_estate_property_scroll_to_top_type', 'advance-scroll' ) == 'advance-scroll' ) { ?>
        <?php do_action('real_estate_property_top_scroller'); ?>
    <?php } elseif ( get_theme_mod( 'real_estate_property_scroll_to_top_type' ) == 'simple-scroll' ) { ?>
